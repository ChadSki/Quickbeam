...
namespace ModernIde.Helpers.Net
{
    /// <summary>
    ...
    public static class AssemblyServer
    {
        ...
        ///     The type of the request object that should be sent. This must inherit from
        ///     ServerRequest.
        /// </typeparam>
        /// <typeparam name="TResultType">
        ///     The type of the result object that should be returned. This must inherit from
        ///     ServerResponse.
        /// </typeparam>
