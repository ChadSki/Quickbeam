...
namespace Blamite.Patching
{
    public static class SegmentComparer
    {
        ...
        public static List<SegmentChange> CompareSegments(IEnumerable<FileSegment> originalSegments,
            ...
            IEnumerable<FileSegment> newSegments, IReader newReader)
        {
            ...
            for (int i = 0; i < originalList.Count; i++)
            {
                ...
                {
                    var change = new SegmentChange((uint) originalSegment.Offset, originalSegment.ActualSize,
                        (uint) newSegment.Offset,
