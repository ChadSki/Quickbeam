...
namespace Blamite.Plugins
{
    public class TestPluginVisitor : IPluginVisitor
    {
        ...
        {
            Debug.WriteLine("Plugin version {0} by {1}: {2}", revision.Version, revision.Researcher,
        ...
        public void VisitTagReference(string name, uint offset, bool visible, bool withClass, bool showJumpTo,
            uint pluginLine)
        {
        ...
        {
            Debug.WriteLine("Reflexive \"{0}\" at {1}, visible = {2}, entrySize = {3}, align = {4}", name, offset,
                visible, entrySize, align);
            Debug.Indent();
            return true;
        }
        ...
        {
            Debug.WriteLine("Data reference \"{0}\" at {1}, format = {2}, visible = {3}, align = {4}", name, offset,
                format, visible, align);
        }
