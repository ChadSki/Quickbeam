    ...
    public class SecondGenCacheFile : ICacheFile
    {
        ...
        private SecondGenHeader LoadHeader(IReader reader, EngineDescription buildInfo, string buildString)
        {
            ...
            StructureValueCollection values = StructureReader.ReadStructure(reader,
                buildInfo.Layouts.GetLayout("header"));
        ...
        private SecondGenTagTable LoadTagTable(IReader reader, EngineDescription buildInfo)
        {
            ...
            StructureValueCollection values = StructureReader.ReadStructure(reader,
                buildInfo.Layouts.GetLayout("meta header"));
        ...
        {
            var strings = new IndexedStringTable(reader, _header.FileNameCount, _header.FileNameIndexTable,
                _header.FileNameData,
        ...
        {
            var strings = new IndexedStringTable(reader, _header.StringIDCount, _header.StringIDIndexTable,
                _header.StringIDData,
