...
namespace Blamite.Blam.Scripting
{
    public class OpcodeLookup
    {
        ...
        private readonly Dictionary<string, ScriptValueType> _typeLookupByName =
            new Dictionary<string, ScriptValueType>();

        private readonly Dictionary<ushort, ScriptValueType> _typeLookupByOpcode =
            new Dictionary<ushort, ScriptValueType>();
