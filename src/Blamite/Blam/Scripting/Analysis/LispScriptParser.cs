...
// GPPG version 1.5.0
// Machine:  TJ-FRONTPC
// DateTime: 12/18/2013 3:04:00 PM
// UserName: TJ
// Input file <Blam\Scripting\Analysis\LispScriptParser.y - 12/18/2013 3:03:12 PM>
...
#pragma warning restore 649
        private static readonly Rule[] rules = new Rule[26];
        private static readonly State[] states = new State[48];
        ...
        {
            states[0] = new State(-2, new[] {-1, 1});
            states[1] = new State(new[] {46, 2, 40, 5}, new[] {-3, 3, -4, 4, -5, 47});
            states[2] = new State(-1);
            states[3] = new State(-3);
            states[4] = new State(-4);
            states[5] = new State(new[] {47, 6, 48, 28});
            states[6] = new State(new[] {49, 7});
            states[7] = new State(new[] {49, 8});
            states[8] = new State(new[] {50, 12, 51, 13, 52, 14, 53, 15, 40, 17, 49, 24},
                new[] {-6, 9, -7, 11, -8, 16, -9, 23});
            states[9] = new State(new[] {41, 10});
            ...
            states[17] = new State(new[] {49, 26, 50, 27}, new[] {-2, 18});
            states[18] = new State(new[] {41, 19, 50, 12, 51, 13, 52, 14, 53, 15, 40, 17, 49, 24},
                new[] {-10, 20, -6, 25, -7, 11, -8, 16, -9, 23});
            states[19] = new State(-23);
            states[20] = new State(new[] {41, 21, 50, 12, 51, 13, 52, 14, 53, 15, 40, 17, 49, 24},
                new[] {-6, 22, -7, 11, -8, 16, -9, 23});
            ...
            states[28] = new State(new[] {49, 29});
            states[29] = new State(new[] {49, 30});
            states[30] = new State(new[] {40, 34, 49, 26, 50, 27}, new[] {-2, 31});
            states[31] = new State(new[] {50, 12, 51, 13, 52, 14, 53, 15, 40, 17, 49, 24},
                new[] {-10, 32, -6, 25, -7, 11, -8, 16, -9, 23});
            states[32] = new State(new[] {41, 33, 50, 12, 51, 13, 52, 14, 53, 15, 40, 17, 49, 24},
                new[] {-6, 22, -7, 11, -8, 16, -9, 23});
            states[33] = new State(-9);
            states[34] = new State(new[] {49, 26, 50, 27}, new[] {-2, 35});
            states[35] = new State(new[] {40, 36});
            states[36] = new State(new[] {49, 44}, new[] {-12, 37, -11, 46});
            states[37] = new State(new[] {41, 38, 44, 42});
            states[38] = new State(new[] {41, 39});
            states[39] = new State(new[] {50, 12, 51, 13, 52, 14, 53, 15, 40, 17, 49, 24},
                new[] {-10, 40, -6, 25, -7, 11, -8, 16, -9, 23});
            states[40] = new State(new[] {41, 41, 50, 12, 51, 13, 52, 14, 53, 15, 40, 17, 49, 24},
                new[] {-6, 22, -7, 11, -8, 16, -9, 23});
            states[41] = new State(-10);
            states[42] = new State(new[] {49, 44}, new[] {-11, 43});
            states[43] = new State(-12);
            states[44] = new State(new[] {49, 45});
            ...
            rules[1] = new Rule(-13, new[] {-1, 46});
            rules[2] = new Rule(-1, new int[] {});
            rules[3] = new Rule(-1, new[] {-1, -3});
            rules[4] = new Rule(-3, new[] {-4});
            rules[5] = new Rule(-3, new[] {-5});
            rules[6] = new Rule(-4, new[] {40, 47, 49, 49, -6, 41});
            rules[7] = new Rule(-2, new[] {49});
            rules[8] = new Rule(-2, new[] {50});
            rules[9] = new Rule(-5, new[] {40, 48, 49, 49, -2, -10, 41});
            rules[10] = new Rule(-5, new[] {40, 48, 49, 49, 40, -2, 40, -12, 41, 41, -10, 41});
            rules[11] = new Rule(-12, new[] {-11});
            rules[12] = new Rule(-12, new[] {-12, 44, -11});
            rules[13] = new Rule(-11, new[] {49, 49});
            rules[14] = new Rule(-10, new[] {-6});
            rules[15] = new Rule(-10, new[] {-10, -6});
            rules[16] = new Rule(-6, new[] {-7});
            rules[17] = new Rule(-6, new[] {-8});
            rules[18] = new Rule(-6, new[] {-9});
            rules[19] = new Rule(-7, new[] {50});
            rules[20] = new Rule(-7, new[] {51});
            rules[21] = new Rule(-7, new[] {52});
            rules[22] = new Rule(-7, new[] {53});
            rules[23] = new Rule(-8, new[] {40, -2, 41});
            rules[24] = new Rule(-8, new[] {40, -2, -10, 41});
            rules[25] = new Rule(-9, new[] {49});
        }

        protected override void Initialize()
        {
            InitSpecialTokens((int) LispScriptTokens.error, (int) LispScriptTokens.EOF);
            InitStates(states);
            InitRules(rules);
...
#line 45 "Blam\Scripting\Analysis\LispScriptParser.y"
                {
                    CurrentSemanticValue.Node = new GlobalDefinitionNode(ValueStack[ValueStack.Depth - 3].StringValue,
                        ValueStack[ValueStack.Depth - 4].StringValue, ValueStack[ValueStack.Depth - 2].Node);
                }
                    break;
...
#line 56 "Blam\Scripting\Analysis\LispScriptParser.y"
                    var def = new ScriptDefinitionNode(ValueStack[ValueStack.Depth - 3].StringValue,
                        ValueStack[ValueStack.Depth - 5].StringValue, ValueStack[ValueStack.Depth - 4].StringValue);
...
#line 62 "Blam\Scripting\Analysis\LispScriptParser.y"
                    var def = new ScriptDefinitionNode(ValueStack[ValueStack.Depth - 7].StringValue,
                        ValueStack[ValueStack.Depth - 10].StringValue, ValueStack[ValueStack.Depth - 9].StringValue);
...
#line 70 "Blam\Scripting\Analysis\LispScriptParser.y"
                {
                    CurrentSemanticValue.ParamList = new List<ScriptDefinitionParam>();
                    CurrentSemanticValue.ParamList.Add(ValueStack[ValueStack.Depth - 1].Parameter);
                }
                    break;
                case 12: // parameters -> parameters, ',', parameter
#line 72 "Blam\Scripting\Analysis\LispScriptParser.y"
                {
                    CurrentSemanticValue.ParamList = ValueStack[ValueStack.Depth - 3].ParamList;
                    CurrentSemanticValue.ParamList.Add(ValueStack[ValueStack.Depth - 1].Parameter);
                }
                    break;
...
#line 76 "Blam\Scripting\Analysis\LispScriptParser.y"
                {
                    CurrentSemanticValue.Parameter =
                        new ScriptDefinitionParam(ValueStack[ValueStack.Depth - 1].StringValue,
                            ValueStack[ValueStack.Depth - 2].StringValue);
                }
                    break;
                case 14: // expressions -> expression
#line 80 "Blam\Scripting\Analysis\LispScriptParser.y"
                {
                    CurrentSemanticValue.NodeList = new List<IScriptNode>();
...
#pragma warning restore 162, 1522
        ...
        protected override string TerminalToString(int terminal)
        {
            ...
            if (((LispScriptTokens) terminal).ToString() != terminal.ToString(CultureInfo.InvariantCulture))
