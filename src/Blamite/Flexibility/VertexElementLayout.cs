namespace Blamite.Flexibility
{
    ...
    public enum VertexElementType
    {
        ...
        UDec4N,
        // 4D unsigned 10-bit 10-bit 10-bit 2-bit vector, normalized by dividing by (1023.0f, 1023.0f, 1023.0f, 3.0f)
    ...
    {
        public VertexElementLayout(int stream, int offset, VertexElementType type, VertexElementUsage usage,
            int usageIndex)
        {
            Stream = stream;
            Offset = offset;
