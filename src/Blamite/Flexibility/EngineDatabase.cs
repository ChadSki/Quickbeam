...
namespace Blamite.Flexibility
{
    ...
    {
        private readonly Dictionary<string, EngineDescription> _enginesByName =
            new Dictionary<string, EngineDescription>();

        private readonly Dictionary<string, EngineDescription> _enginesByVersion =
            new Dictionary<string, EngineDescription>();
