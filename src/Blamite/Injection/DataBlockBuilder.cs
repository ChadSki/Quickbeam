...
namespace Blamite.Injection
{
    ...
    public class DataBlockBuilder : IPluginVisitor
    {
        ...
        public DataBlockBuilder(IReader reader, SegmentPointer tagLocation, ICacheFile cacheFile,
        ...
        public void VisitRange(string name, uint offset, bool visible, string type, double min, double max,
            double smallChange,
        ...
        {
            SeekToOffset(block, offset);
            byte[] data = _cacheFile.ShaderStreamer.ExportShader(_reader, type);
