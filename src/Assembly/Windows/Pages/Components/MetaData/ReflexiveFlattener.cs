...
namespace Assembly.Windows.Pages.Components.MetaData
{
    ...
    public class ReflexiveFlattener : IMetaFieldVisitor
    {
        ...
        public void VisitReflexive(ReflexiveData field)
        {
            ...
            {
                WrappedReflexiveEntry wrapper = flattened.WrapField(field.Template[i], field.Width,
                    i == field.Template.Count - 1);
                _index++;
            ...
            if (e.PropertyName == "IsExpanded")
            {
                if (reflexive.IsExpanded)
                    ...
                    flattenedField.Contract();
                     ...
                     (e.PropertyName == "CurrentIndex" || e.PropertyName == "FirstEntryAddress" ||
                      e.PropertyName == "EntrySize"))
            {
                _loading = true;
