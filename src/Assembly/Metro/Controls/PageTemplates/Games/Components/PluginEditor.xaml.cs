...
namespace Assembly.Metro.Controls.PageTemplates.Games.Components
{
    ...
    public partial class PluginEditor
    {
        ...
        private void LoadCodeCompletion()
        {
            ...
            withClass.RegisterValue(new CompletableXMLValue("true",
                "The reference includes a 12-byte class ID (default)"));
            ...
            var format = new CompletableXMLAttribute("format",
                "The format of the data in the dataref (optional, default=bytes)");
