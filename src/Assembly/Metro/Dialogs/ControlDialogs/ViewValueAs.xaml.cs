...
namespace Assembly.Metro.Dialogs.ControlDialogs
{
    ...
    public partial class ViewValueAs
    {
        ...
        {
            _reader = new MetaReader(_streamManager, _cacheOffset, _cacheFile, _buildInfo, MetaReader.LoadType.File,
                null);
        ...
        private void btnRefresh_Click(object sender = null, RoutedEventArgs e = null)
        {
            ...
            {
                // Is Hex
                success = int.TryParse(txtOffset.Text.Substring(2), NumberStyles.HexNumber, CultureInfo.InvariantCulture,
                    out offset);
            }
            else
            {
