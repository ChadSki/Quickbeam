    ...
    public static class AssemblyProtocol
    {
        public static void UpdateProtocol()
        {
            ...
            if (keyProtoDefaultIcon != null)
                keyProtoDefaultIcon.SetValue("",
                    VariousFunctions.GetApplicationLocation() + "AssemblyIconLibrary.dll,100");
...
#pragma warning restore 168
            ...
            if (keyProtoShellOpenCommand != null)
                keyProtoShellOpenCommand.SetValue("",
                    string.Format("\"{0}\" %1", VariousFunctions.GetApplicationAssemblyLocation()));
        }
    }
}