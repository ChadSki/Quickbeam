...
namespace Assembly.Helpers.PostGeneration
{
    public class BlamitePostGenerator
    {
        ...
        public string Parse()
        {
            ...
            modInfoList +=
                BBCodeListOption(BBCodeBold("Patch Download: ") + BBCodeUrl("Download", PostInfo.ModPatchDownload),
                    true);
            ...
            attributeList +=
                BBCodeListOption(
                    "[ " + BBCodeBold(PostInfo.AiEdits ? BBCodeColour("Yes", "009900") : BBCodeColour("No", "FF0000")) +
                    " ] Ai Edits",
                    true);
            attributeList +=
                BBCodeListOption(
