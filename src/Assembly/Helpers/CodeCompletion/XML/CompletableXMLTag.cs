...
namespace Assembly.Helpers.CodeCompletion.XML
{
    ...
    {
        private readonly List<CompletableXMLAttribute> _attributes = new List<CompletableXMLAttribute>();

        private readonly Dictionary<string, CompletableXMLAttribute> _attributesByName =
